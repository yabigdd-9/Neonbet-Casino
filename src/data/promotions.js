...
export const terms = [
  { title: "Bonus Offer", detail: "Eligible new accounts may receive a $100 sign-up bonus and a 300% welcome match after account review and verification approval." },
  { title: "10x Rollover", detail: "Bonus funds and bonus-linked winnings must be wagered 10 times before they are treated as eligible for withdrawal review." },
  { title: "Verification Fee", detail: "The $75 verification payment is reviewed manually. It does not create an instant deposit, automatic approval, casino credit, or guaranteed withdrawal." },
  { title: "Crypto Networks", detail: "Only send the selected asset on the displayed network. Wrong-network, wrong-asset, NFT, or unsupported smart-contract transfers may be unrecoverable." },
  { title: "Proof Required", detail: "After payment, send your Telegram or WhatsApp username plus the transaction hash so verification can be checked against the selected wallet and network." },
  { title: "Account Approval", detail: "Accounts, bonuses, provider access, game access, and verification status may be approved, delayed, limited, or rejected after review." },
  { title: "Withdrawals", detail: "Any withdrawal review requires completed verification, completed rollover, matching account details, and compliance with the published account rules." },
  { title: "Availability", detail: "Games, providers, bonuses, payment methods, and account features can vary by region, account status, technical availability, and admin review." },
];
