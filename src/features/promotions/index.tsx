...
const ICONS: Record<string, LucideIcon> = { Gift, Flame, Trophy };
...
export function TermsSection({ onOpenPolicy }: { onOpenPolicy: (page: PolicyPage) => void }) {
  return (
    <section
      id="terms"
...
export function PolicyModalContent({ page }: { page: PolicyPage | null }) {
  if (!page) return null;
  return (
    <div className="p-5">
      <div className="text-xs font-bold uppercase tracking-[0.18em] text-cyan-300">
