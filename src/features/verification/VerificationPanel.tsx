...
interface VerificationPanelProps {
  ...
  onSubmitVerification: (method: { name: string; network: string }, txHash: string) => void;
    ...
    <section className="grid scroll-mt-24 gap-5 xl:grid-cols-[1.2fr_0.8fr]" id="verification">
      ...
      <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 md:p-8">
        ...
        >
          ...
          <Button
            type="submit"
            disabled={verificationSaving || (user != null && !txHash.trim())}
          ...
          {latestSubmission && (
            <p className="mt-3 text-xs leading-5 text-cyan-100">
              ...
              {statusLabel(latestSubmission.status || "not_submitted")}.
            </p>
          )}
        </form>
